# Entrust Identity Verification SDK for React Native

The **Entrust Identity Verification SDK for React Native** (formerly the Onfido React Native Smart Capture SDK) provides a set of screens and modules that enable applications to implement user identity verification flows.
